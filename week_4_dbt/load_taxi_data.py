...
# Modified base URL for GitHub releases
BASE_URL = "https://github.com/DataTalksClub/nyc-tlc-data/releases/download/green/green_tripdata_"

# Generate all green taxi files from 2019-2021
# 2019: 12 months, 2020: 12 months, 2021: 9 months (total 33 files)
YEARS_MONTHS = {
    2019: range(1, 13),  # Jan-Dec
    2020: range(1, 13),  # Jan-Dec
}
...
def download_file(filename):
    ...
    file_path = os.path.join(DOWNLOAD_DIR, f"green_tripdata_{filename}")
